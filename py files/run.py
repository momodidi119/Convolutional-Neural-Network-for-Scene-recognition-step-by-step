...
train_X = train_images[:550]
test_X = test_images[:100]
training_data = train_X.reshape(550, 1, 28, 28)
training_labels = train_labels[:550]  # numpy.ndarray 55000*10
testing_data = test_X.reshape(100, 1, 28, 28)
testing_labels = test_labels[:100]
...
LeNet.train(training_data=training_data,training_label=training_labels,batch_size=55,epoch=3,weights_file="pretrained_weights.pkl")
# %%
print('Testing Lenet......')
LeNet.test(data=testing_data,label=testing_labels,test_size=100)

print('Testing with pretrained weights......')
LeNet.test_with_pretrained_weights(testing_data, testing_labels, 100, 'pretrained_weights.pkl')
# %%
